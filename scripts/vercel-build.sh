...
cp main.js moreGames.js play365Games.js i18n.js style.css .vercel/output/static/ 2>/dev/null || true
cp image.png manifest.webmanifest .vercel/output/static/ 2>/dev/null || true
cp -r i18n images icons audios thumbnails .vercel/output/static/
